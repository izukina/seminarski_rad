...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=1464096170ltr&server=1">
...
<body>
    <div id="pma_navigation" data-config-navigation-width="186">
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=seminarska_baza&table=clanak">`seminarska_baza`.`clanak`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=seminarska_baza&table=korisnik">`seminarska_baza`.`korisnik`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=nova_baza&table=nova_tablica">`nova_baza`.`nova_tablica`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=users&table=korisnik">`users`.`korisnik`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=vjezba_3&table=korisnik">`vjezba_3`.`korisnik`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=seminarska_baza&table=Clanak">`seminarska_baza`.`Clanak`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=users&table=korisnik3">`users`.`korisnik3`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=users&table=korisnik2">`users`.`korisnik2`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=users&table=user">`users`.`user`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=nova_baza&table=Nova_tablica">`nova_baza`.`Nova_tablica`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="23324e2d292229357658597d34406a49">
